 ...
 --2
 --Get the cities of agents booking an order for customer c002. Use joins.
 SELECT city
 FROM agents a, 
      orders o
 WHERE o.aid = a.aid
 ...
 --7
 --Get the names of customers who placed at least one order through 
 --an agent in their city.
 ...
 --8
 --Get the names of customers and agents in the same city, along with the name 
 ...
 --This means calculating Orders.dollars from other data in other tables 
 --and then comparing those values to the values in Orders.dollars.
